...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-PocketForecast/NanoFrame.framework"
  install_framework "Pods-PocketForecast/PaperFold.framework"
  install_framework "Pods-PocketForecast/SwiftCSV.framework"
